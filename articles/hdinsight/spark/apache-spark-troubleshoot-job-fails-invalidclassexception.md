...
This error can be caused by adding an additional jar to the `spark.yarn.jars` config, a shaded jar that includes a different version of the `commons-lang3` package and introduces a class mismatch. By default, Spark 2.1/2/3 uses version 3.5 of `commons-lang3`.
